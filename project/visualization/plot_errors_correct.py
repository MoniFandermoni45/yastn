...
data_pred_01_myVersion = np.load('data/errors_ising_01_NN+_withPredisentangler_myVersion_version_1_correct.npz')
data_pred_01_myVersion_version_2 = np.load('data/errors_ising_01_NN+_withPredisentangler_myVersion_version_2_correct.npz')
...
x = np.linspace(0, 1.643, len(errors6_pred_01_myVersion))
...
plt.savefig('visualization/accumulated_evolution_error_NN+_01_myVersion_version_2_correct.svg')
plt.show()
